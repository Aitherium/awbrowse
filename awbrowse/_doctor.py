"""Stack-aware `doctor` for awbrowse.
...
interesting failures live BETWEEN them. "awbrowse is installed" is not the useful
fact -- "awbrowse is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awbrowse'
FAMILY = ['awask', 'awask', 'awbac', 'awdit', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['adk', 'awfind']
...
#: gets ignored.
ENV_REQUIRED = []
ENV_OPTIONAL = ['AWBROWSE_TOKEN', 'AWBROWSE_URL']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awbrowse needs at runtime, and a
